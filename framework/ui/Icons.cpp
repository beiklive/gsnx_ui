...
constexpr MaterialEntry kMaterialTable[] = {
    ...
    {Material::InstallApp, "install_app", 0xEB72}, // Material 没有 install_app，用 install_mobile
    ...
    {Material::CloudUpload, "cloud_upload", 0xE2C3},
    {Material::CloudDownload, "cloud_download", 0xE2C0},
    {Material::PhotoLibrary, "photo_library", 0xE413},
    {Material::Folder, "folder", 0xE2C7},
    {Material::Games, "games", 0xE021},
    {Material::SportsEsports, "sports_esports", 0xEA28},
    {Material::VideogameAsset, "videogame_asset", 0xE338},
    {Material::PhoneAndroid, "phone_android", 0xE324},
    {Material::Archive, "archive", 0xE149},
    {Material::FileGame, "file_game", 0xEA28}, // Material 没有 file_game，借 sports_esports
